...
import InspectionScene from '@/components/InspectionScene';
...
export default function LoginPage() {
  ...
  return (
    <div className="auth-shell text-slate-100">
      <InspectionScene />
      <div className="auth-card w-full max-w-md rounded-2xl border border-slate-800 bg-[#0F172A]/90 p-8 shadow-2xl backdrop-blur-xl">
        {/* Brand Header */}
